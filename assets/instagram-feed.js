...
if (!customElements.get('m-instagram')) {
  class MInstagram extends HTMLElement {
    constructor() {
      super();
    }
    ...
    connectedCallback() {
      ...
      if (accessToken) {
        new MinimogTheme.Instagram(this, accessToken, imagesCount);
      }
    }

  }

  customElements.define('m-instagram', MInstagram);
}
}();
/******/ })()
;