...
class Customer {
  constructor() {
    ...
    _defineProperty(this, "initFormNew", () => {
      ...
      this?.formNewNodes?.add?.addEventListener("click", () => this.toggleFormNew(true));
      this?.formNewNodes?.cancel?.addEventListener("click", () => this.toggleFormNew(false));
