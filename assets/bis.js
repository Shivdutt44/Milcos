...
const Popup = _ref => {
  ...
  console.log(productData, 'product-data', has_only_default_variant);
  ...
  }, title), Popup_createElement("p", null, variants?.length > 1 ? `${variant_title}  -  ` : null, priceNode))), Popup_createElement("div", {
